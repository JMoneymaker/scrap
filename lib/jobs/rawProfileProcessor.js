...
module.exports = async(job) => {
  ...
  try {
    ...
    await page.waitFor('#DataGridAgcyEmp tr:nth-child(2) a');
    ...
    await page.waitFor('input[name="BtnProfile"]');  
    ...
    const rawProfile = await RawProfileReport.create({ dpsstId: job.data.id, html });
    parsedProfileQueue.add({ id: rawProfile._id  }, { jobId: rawProfile._id });
  }
